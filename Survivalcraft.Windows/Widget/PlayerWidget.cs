...
namespace Game {
    public class PlayerWidget : CanvasWidget {
        ...
        public override void Update() {
            SubsystemGameInfo subsystemGameInfo = m_playerData.SubsystemPlayers.Project.FindSubsystem<SubsystemGameInfo>(true);
