						...
						case 2:
							{
								...
								Vector3 position2 = new(terrainRaycastResult.Value.CellFace.X + 0.5f, terrainRaycastResult.Value.CellFace.Y + 1.25f, terrainRaycastResult.Value.CellFace.Z + 0.5f);
						...
						case 8:
							{
								...
								Vector3 position = new(terrainRaycastResult.Value.CellFace.X + 0.5f, terrainRaycastResult.Value.CellFace.Y + 1.2f, terrainRaycastResult.Value.CellFace.Z + 0.5f);
