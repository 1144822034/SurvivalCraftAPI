...
namespace Game
{
	public class BlockColorsMap
	{
		...
		public static BlockColorsMap OakLeaves = new(new Color(96, 161, 123), new Color(174, 164, 42), new Color(96, 161, 123), new Color(30, 191, 1));

		public static BlockColorsMap BirchLeaves = new(new Color(76, 181, 96), new Color(174, 109, 42), new Color(66, 215, 116), new Color(77, 235, 96));

		public static BlockColorsMap MimosaLeaves = new(new Color(146, 191, 176), new Color(160, 191, 176), new Color(146, 191, 166), new Color(150, 201, 141));

		public static BlockColorsMap PoplarLeaves = new(new Color(76, 181, 96), new Color(174, 109, 42), new Color(56, 205, 106), new Color(67, 215, 86));

		public static BlockColorsMap SpruceLeaves = new(new Color(96, 161, 155), new Color(129, 174, 42), new Color(96, 161, 155), new Color(1, 191, 53));

		public static BlockColorsMap TallSpruceLeaves = new(new Color(90, 141, 165), new Color(119, 152, 51), new Color(86, 141, 165), new Color(1, 158, 65));
