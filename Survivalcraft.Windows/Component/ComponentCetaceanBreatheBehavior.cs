	...
	public class ComponentCetaceanBreatheBehavior : ComponentBehavior, IUpdateable
	{
		...
		public virtual Vector3? FindSurfaceDestination()
		{
			...
			for (int i = 0; i < 16; i++)
			{
				...
				TerrainRaycastResult? terrainRaycastResult = m_subsystemTerrain.Raycast(vector, end, useInteractionBoxes: false, skipAirBlocks: false, (value,_) => Terrain.ExtractContents(value) != 18);
